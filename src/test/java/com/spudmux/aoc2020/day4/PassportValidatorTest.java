...
public class PassportValidatorTest {
    ...
    public void testWithSampleInput() {
        ProblemInput input = new ProblemInput("day4/part1-sample-input.txt");
    ...
    public void testWithProblemInput() {
        ProblemInput input = new ProblemInput("day4-input.txt");
        PassportValidator validator = new PassportValidator(input);
    ...
    public void testPartTwoSampleInvalidPassports() {
        ProblemInput input = new ProblemInput("day4/part2-sample-input-invalid-passports.txt");
        PassportValidator validator = new PassportValidator(input);
    ...
    public void testPartTwoSampleValidPassports() {
        ProblemInput input = new ProblemInput("day4/part2-sample-input-valid-passports.txt");
        PassportValidator validator = new PassportValidator(input);
