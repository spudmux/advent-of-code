...
public class Day12Test {
  ...
  @Test public void testDay12Part1WithSampleInput() {
    ProblemInput input = new ProblemInput(Paths.get("aoc2021/day12-part1-sample-input.txt"));
  ...
  @Test public void testDay12Part1WithProblemInput() {
    ProblemInput input = new ProblemInput(Paths.get("aoc2021/day12-part1-input.txt"));
    Day12 day12 = new Day12(input);
