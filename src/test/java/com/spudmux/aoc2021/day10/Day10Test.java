...
public class Day10Test {
  ...
  @Test public void testDay10Part1WithSampleInput() {
    ProblemInput input = new ProblemInput(Paths.get("aoc2021/day10-part1-sample-input.txt"));
  ...
  @Test public void testDay10Part1WithProblemInput() {
    ProblemInput input = new ProblemInput(Paths.get("aoc2021/day10-part1-input.txt"));
    Day10 day10 = new Day10(input);
