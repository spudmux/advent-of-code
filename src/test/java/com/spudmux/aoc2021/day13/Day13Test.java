...
public class Day13Test {
  ...
  @Test public void testDay13Part1WithSampleInput() {
    ProblemInput input = new ProblemInput(Paths.get("aoc2021/day13-part1-sample-input.txt"));
  ...
  @Test public void testDay13Part1WithProblemInput() {
    ProblemInput input = new ProblemInput(Paths.get("aoc2021/day13-part1-input.txt"));
    Day13 day13 = new Day13(input);
