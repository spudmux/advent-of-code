...
public class Day4Test {
    ...
    public void testDay4Part1Sample() {
        Day4 day4 = new Day4(new ProblemInput(Paths.get("aoc2021/day4-part1-sample-input.txt")));
        day4.calculate();
    ...
    public void testDay4Part1() {
        Day4 day4 = new Day4(new ProblemInput(Paths.get("aoc2021/day4-part1-input.txt")));
        day4.calculate();
